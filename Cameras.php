...
<head>
    <title>Best Place | Camaras</title>
    <meta charset="utf-8">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 ">
                ...
                <h1 class="col-12 bg-info fs-1 fw-bolder rows-10 pt-3 pb-3 text-center ligh" style="--i:1;">Camaras
                <!-- <input type="text" class="in col-4 col-lg-2 offset-lg-2 offset-1 mt-1"/>
                     <button class="col-3 col-lg-1 fs-4 btn btn-dark text-white" style="height: 45px;">Search</button> --></h1> 
                          <!--slide-->
                        ...
                        <div id="carouselExampleCaptions" class="offset-2 col-8 carousel slide" data-bs-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="resources/c1.jpg" class="w-100  d-block posterimg1">
                                ...
                                <div class="carousel-item">
                                    <img src="resources/c3.jpg" class="d-block w-100 posterimg1">
                                    <div class="carousel-caption d-none d-md-block postercaption ">
        ...
        <p>Some representative placeholder content for the second slide.</p>
                                ...
                                <div class="carousel-item">
                                    <img src="resources/c2.jpg" class="d-block w-100 posterimg1">
                ...
                <?php
                       ...
                       $resultset=Database::search("SELECT * FROM `product` WHERE `category_id`='3' ORDER BY `datetime_added`;");
                ...
                <div class="col-12">
                    ...
                    <div class="col-12 mt-5">
                        <div class="row row-cols-12 ms-5 row-cols-md-3 row-cols-lg-5 g-5 offset-lg-3 col-12 col-lg-10 " id="pdetails">
                            ...
                            <?php
                                    ...
                                    ?>
                                     ...
                                     <div class="card col-6 col-lg-2 mt-6  ms-1  " style="width: 17rem; ">
