...
<head>
    <title>Best Place | Laptop And Tablates</title>
    <meta charset="utf-8">
...
<body>
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 ">
                <div class="row">
                 ...
                 <h1 class="col-12 bg-info fs-1 fw-bolder rows-10 pt-3 pb-3 text-center ligh" style="--i:1;">Laptop And Tablates
                        ...
                        <div id="carouselExampleCaptions" class="offset-2 col-8 carousel slide" data-bs-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="resources/t1.jpg" class="w-100  d-block posterimg1">
                                ...
                                <div class="carousel-item">
                                    <img src="resources/t2.jpg" class="d-block w-100 posterimg1">
                                    <div class="carousel-caption d-none d-md-block postercaption ">
        ...
        <p>Some representative placeholder content for the second slide.</p>
                                ...
                                <div class="carousel-item">
                                    <img src="resources/t3.jpg" class="d-block w-100 posterimg1">
                ...
                <?php
                       ...
                       $resultset=Database::search("SELECT * FROM `product` WHERE `category_id`='2' ORDER BY `datetime_added`;");
