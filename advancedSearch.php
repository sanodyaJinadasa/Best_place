...
<head>
    ...
    <title>best place | Advanced Search</title>
                ...
                <div class="row">
                    <div class="offset-0 offset-lg-4 col-12 col-lg-4 ">
                        <div class="row">
                            ...
                            <div class="col-10">
                                <lable class="text-info fw-bold fs-2 mt-4">Advanced Search</lable>
                            </div>
                    ...
                    <div class="offset-0 offset-lg-1 col-12 col-lg-10">
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-2 mt-3 mb-2 d-grid">
                                <button class="btn btn-info searchbtn1" onclick="advancedSearch(0);">Search</button>
                            </div>
                            <div class="col-12">
            ...
            <div class="offset-o offset-lg-2 col-12 col-lg-8 bg-white mt-3 mb-3 rounded">
                <div class="row">
                    ...
                    <div class="col-3 col-lg-2 mb-2 mt-2">
                        <select class=" form-select border border-2 border-dark border-start-0 border-end-0 border-top-0 d-none" id="sort" onchange="advancedSearch(0);">
                ...
                <div class="row">
                    <div class="offset-0 offset-lg-1 col-12 col-lg-10 text-center" id="filter">
                        <div class="row">
                            ...
                            ?>
                                <div class="card  mb-3 mt-3 col-12 col-lg-6 cr ccr">
                                    <div class="row">
                ...
                <div class="col-12">
                    <div class="row">
                        <div class="offset-2 col-5 text-center">
                            <div class="offset-4 col-6 mb-5 pagination">
                                <a href="
                                <?php
