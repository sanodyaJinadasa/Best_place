...
<body>
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 ">
                <div class="row">
                 ...
                 <h1 class="col-12 bg-info fs-1 fw-bolder offset-0 rows-10 pt-3 pb-3 text-center ligh" style="--i:1;">Phones
                        ...
                        <div id="carouselExampleCaptions" class="offset-2 col-8 carousel slide" data-bs-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="resources/m2.jpg" class="w-100  d-block posterimg1">
                                ...
                                <div class="carousel-item">
                                    <img src="resources/m1.webp" class="d-block w-100 posterimg1">
                                    <div class="carousel-caption d-none d-md-block postercaption ">
        ...
        <p>Some representative placeholder content for the second slide.</p>
                                ...
                                <div class="carousel-item">
                                    <img src="resources/m3.jpg" class="d-block w-100 posterimg1">
                ...
                <?php
                       ...
                       $resultset=Database::search("SELECT * FROM `product` WHERE `category_id`='1' ORDER BY `datetime_added`;");
                ...
                <!------ product view--->
                <div class="col-12 ">
                    <div class="row  mb-1 offset-lg-0" >
                    <div class="col-12 mt-5">
                        <div class="row row-cols-12 ms-5 row-cols-md-3 row-cols-lg-12 g-5 offset-lg- col-12 col-lg-12 " id="pdetails">
