...
require "connection.php";
    ...
    <head>
        <title>Best Place | Admin | Massage</title>
        <meta charset="utf-8">
    ...
    <body style="background-color: #74ebd5; background-image: linear-gradient(90deg,#74ebd5 0%, #9face6 100%);min-height: 100px;">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-12 bg-light text-center rounded cr">
                    <label class="form-label fs-2 fw-bold text-primary ">Message</label>
                </div>
     ...
     -->
                ...
                <div class="col-12  mt-3 mb-2">
                    <div class="row">
                        ...
                        <div class="col-lg-6 bg-light pt-2 pb-2 d-none d-lg-block">
                ...
                $usersrs = Database::search("SELECT * FROM chat");
                $d = $usersrs->num_rows;
                ...
                $selectedrs = Database::search("SELECT * FROM `chat` LIMIT " . $results_per_page . " OFFSET " . $page_first_result . " ");
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-lg-2 bg-light pt-2 pb-2">
                                        <div class="row">
                                            ...
                                            <span class="fs-4 fw-bold text-dark col-6 col-lg-12"><?php echo $srow["email"];?></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-lg-2 bg-secondary pt-2 pb-2">
                                        <div class="row">
                                            <span class="fs-4 fw-bold text-light col-6 col-lg-0 d-block d-lg-none">Mobile</span>
                                            <span class="fs-5 fw-bold text-light col-6 col-lg-12"><?php echo $srow["mobile"]; ?></span>
                                        </div>
                                    </div>
    
    
    
                                    <div class="col-12 col-lg-6 bg-light pt-2 pb-2">
                                        <div class="row">
                                            <span class="fs-4 fw-bold text-dark col-6 col-lg-0 d-block d-lg-none">Message</span>
                                            <span class="fs-4 fw-bold text-dark col-6 col-lg-12"><?php echo $srow["msg"]; ?></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-1 bg-light pt-2 pb-2">
                                        ...
                                        ?>
                                            ...
                                            <button id="blockbutton<?php echo $srow['email']; ?>" class="btn btn-success col-4 offset-4 col-lg-12 offset-lg-0 " onclick="msgpro('<?php echo $srow['email']; ?>')">Done</button>
                                        <?php
                                        } else {
                                        ?>
                                        <button id="blockbutton<?php echo $srow['email']; ?>" class="btn btn-danger col-4 offset-4 col-lg-12 offset-lg-0" onclick="msgpro('<?php echo $srow['email']; ?>')">Availabel</button>
    ...
    <div class="col-12 ds" style="margin-top: 328px;">
            <?php require "footer.php"; ?>
        </div>
